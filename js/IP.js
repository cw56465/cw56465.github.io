...
$.ajax({
    ...
    data: {
        key: 'ZGHBZ-CJILJ-GEOF7-F7O2X-KGAGE-CHF64',
        output: 'jsonp',
    },
    dataType: 'jsonp',
...
function showWelcome() {
    ...
    let dist = getDistance(117.7490955,35.9194558, ipLoacation.result.location.lng, ipLoacation.result.location.lat); //经纬度替换成自己的位置
